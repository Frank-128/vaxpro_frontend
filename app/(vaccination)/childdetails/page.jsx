        ...
        {ward && (
          <div>
            ...
            <Typography
              ...
              className="text-black lg:text-xl"
            >
              {ward.ward_name} - {ward.district.district_name} - {ward.district.region.region_name}
            </Typography>
          </div>
        )}
      </CardBody>
...
function ParentCard({ parents_guardians }) {
  return (
    <Card className="rounded-lg shadow-lg bg-[#ffffff]" shadow={true}>
      <CardBody className="text-left flex flex-col gap-3">
        {parents_guardians && parents_guardians.map((parent, index) => (
          <div key={index}>
            <Typography
              color="blue-gray"
              className="text-black lg:text-xl flex gap-3"
            >
              <div className="font-bold"> Parent Firstname:</div> {parent.firstname}
            </Typography>
            ...
            <Typography
              ...
              className="text-black lg:text-xl flex gap-3"
            >
              <div className="font-bold"> Parent Middlename:</div> {parent.middlename}
            </Typography>
            <Typography
              color="blue-gray"
              className="text-black lg:text-xl flex gap-3"
            >
              <div className="font-bold"> Parent Lastname:</div> {parent.lastname}
            </Typography>
            <Typography
              color="blue-gray"
              className="text-black lg:text-xl flex gap-3"
            >
              <div className="font-bold ">Relation with child:</div> {parent.pivot.relationship_with_child}
            </Typography>
            <Typography
              color="blue-gray"
              className="text-black lg:text-xl flex gap-3"
            >
              <div className="font-bold">Contacts:</div> {parent.user.contacts}
            </Typography>
          </div>
        ))}
      </CardBody>
...
function TeamCard({ firstname, middlename, surname, card_no, date_of_birth, parents_guardians, ward }) {
  return (
    <div className="flex flex-col gap-4">
      <ChildCard firstname={firstname} middlename={middlename} surname={surname} ward={ward} card_no={card_no} date_of_birth={date_of_birth} />
