        ...
        <>
          ...
          loggedInUser.role?.account_type === "branch_manager" ? (
            ...
            <div className="container mx-auto">
              ...
              <div className="grid grid-cols-1 mt-6 gap-6 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div
                className={
                  "w-full h-96 flex flex-col mb-6  mt-12 underline"
                }
              >
                <Typography
                  className={
                    "text-black text-xs lg:text-base justify-center mb-14 items-center flex w-full font-monte-1 "
                  }
                >
                  The Chart Showing Users Data
                </Typography>
                <ResponsiveContainer
                  width="100%"
                  height="100%"
                >
                  <PieChart  width={400} height={400}>
                    ...
                    <Pie
                      ...
                      outerRadius={ screenWidth > 900 ? 150 : 70}
                      fill="#8884d8"
                      dataKey="value"
                    >
